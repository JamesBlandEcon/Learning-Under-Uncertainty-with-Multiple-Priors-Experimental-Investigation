...
ll{1} = @(x)    A_loglike_BAYES_Beta([E1_Choice_A E1_Choice_A2],[E1_SafeOption_A E1_SafeOption_A2],x(:,1:4),[E1_NumDraws_A E1_NumDraws_A2],[E1_Draw_A E1_Draw_A2],[E1_DecisionColor_A E1_DecisionColor_A2])...
              +A_loglike_BAYES_Beta(E1_Choice_C,E1_SafeOption_C,[x(:,1:2) x(:,9:10)],E1_NumDraws_C,E1_Draw_C,E1_DecisionColor_C)...
              +R_loglike2(       E1_Choice_R,E1_Prob_R,E1_SafeOption_R,x(:,1:2));
% 01 - A-Bayes & C-MP
ll{2} = @(x)    A_loglike_BAYES_Beta([E1_Choice_A E1_Choice_A2],[E1_SafeOption_A E1_SafeOption_A2],x(:,1:4),[E1_NumDraws_A E1_NumDraws_A2],[E1_Draw_A E1_Draw_A2],[E1_DecisionColor_A E1_DecisionColor_A2])...
              +A_loglike_MPbeta_black(E1_Choice_C,E1_Prob_C,E1_SafeOption_C,[x(:,1:2) x(:,11:14)],E1_NumDraws_C,E1_Draw_C,E1_DecisionColor_C)...
              +R_loglike2(       E1_Choice_R,E1_Prob_R,E1_SafeOption_R,x(:,1:2));

% 10 - A-MP & C-Bayes
ll{3} = @(x)    A_loglike_MPbeta_black([E1_Choice_A E1_Choice_A2],[E1_Prob_A E1_Prob_A2],[E1_SafeOption_A E1_SafeOption_A2],[x(:,1:2) x(:,5:8)],[E1_NumDraws_A E1_NumDraws_A2],[E1_Draw_A E1_Draw_A2],[E1_DecisionColor_A E1_DecisionColor_A2])...
              +   A_loglike_BAYES_Beta(E1_Choice_C,E1_SafeOption_C,[x(:,1:2) x(:,9:10)],E1_NumDraws_C,E1_Draw_C,E1_DecisionColor_C)...
              +R_loglike2(       E1_Choice_R,E1_Prob_R,E1_SafeOption_R,x(:,1:2));
...
% 11 - MP in both tasks
ll{4} = @(x)    A_loglike_MPbeta_black([E1_Choice_A E1_Choice_A2],[E1_Prob_A E1_Prob_A2],[E1_SafeOption_A E1_SafeOption_A2],[x(:,1:2) x(:,5:8)],[E1_NumDraws_A E1_NumDraws_A2],[E1_Draw_A E1_Draw_A2],[E1_DecisionColor_A E1_DecisionColor_A2])...
              +   A_loglike_MPbeta_black(E1_Choice_C,E1_Prob_C,E1_SafeOption_C,[x(:,1:2) x(:,11:14)],E1_NumDraws_C,E1_Draw_C,E1_DecisionColor_C)...
              +R_loglike2(       E1_Choice_R,E1_Prob_R,E1_SafeOption_R,x(:,1:2));
